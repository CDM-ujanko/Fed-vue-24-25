let posts = [
    {
        "index": "1af99896-5985-49dd-b2c3-299c9a99092b",
    ...
    {
        "index": "59ca433e-28c3-4892-bdbd-31f46fa28610",
        "picture": "http://placehold.it/32x32",
        "title": "Atgen",
    ...
    {
        "index": "542d4565-fc0c-442c-8804-52aa2e9bf30e",
        "picture": "http://placehold.it/32x32",
        "title": "Vantage",
    ...
    {
        "index": "0d3f5935-d7e6-45bf-a825-e14369da0b1a",
        "picture": "http://placehold.it/32x32",
        "title": "Hairport",
    ...
    {
        "index": "37c065cf-3376-45d4-b6c1-2711bf9e9d0b",
        "picture": "http://placehold.it/32x32",
        "title": "Dognost",
    ...
    {
        "index": "3f9b49b3-78d7-4100-ac74-665e3bad873c",
        "picture": "http://placehold.it/32x32",
        "title": "Insectus",
    ...
    {
        "index": "228ce58f-086d-4ed7-87cc-a6980dadf6a7",
        "picture": "http://placehold.it/32x32",
        "title": "Gorganic",
    ...
    {
        "index": "444da446-e2e7-480d-9a54-adc950a74666",
        "picture": "http://placehold.it/32x32",
        "title": "Sunclipse",
    ...
    {
        "index": "2785f509-9cca-4eb2-b204-9f4a126dbfbe",
        "picture": "http://placehold.it/32x32",
        "title": "Quarx",
    ...
    {
        "index": "d17855ed-775a-410b-bc2e-9ea83fe8a437",
        "picture": "http://placehold.it/32x32",
        "title": "Zomboid",
    ...
    {
        "index": "4d14e3ee-434f-4afc-900c-663e556bf2f0",
        "picture": "http://placehold.it/32x32",
        "title": "Enquility",
    ...
    {
        "index": "c5bb2d51-b0d7-4e72-a652-3d3eaf127346",
        "picture": "http://placehold.it/32x32",
        "title": "Medifax",
    ...
    {
        "index": "2868d6fe-78d3-469e-a3c9-e390bcbd8d45",
        "picture": "http://placehold.it/32x32",
        "title": "Comstruct",
    ...
    {
        "index": "69ff160e-b309-4f62-b615-6fc8afbc817e",
        "picture": "http://placehold.it/32x32",
        "title": "Tourmania",
...
export function getAll() {
    return posts.map((p) => {
        let text = p.text.split(' ').slice(0, 15).join(' ') + '...';
...
export function getPost(id) {
    let matches = posts.filter(p => p.index = id);
    if (matches.length === 0) {
        return matches[0]
    }
